...
(function () {
  ...
  function injectStyles() {
    const css = `
      ...
      .v2ex-ext-github-link:hover {
        color: #333;
      }
      .v2ex-ext-github-link svg {
        width: 13px;
        height: 13px;
        fill: currentColor;
      }
    ...
    panel.innerHTML = `
      ...
      <div class="v2ex-ext-footer">
        ...
        <div class="v2ex-ext-key-actions">
          ...
          <a class="v2ex-ext-github-link" href="https://github.com/greatbody/v2ex-comment-system" target="_blank" title="GitHub 开源仓库">
